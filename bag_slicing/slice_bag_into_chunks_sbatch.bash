...
# Specify the duration of each slice in minutes
CHUNK_DUR=$4
...
python bag_slicing/slice_bag_into_chunks.py ${BIG_BAG_DIR}/${BIG_BAG} --out_dir ${DEST_DIR} --chunk_duration ${CHUNK_DUR}
