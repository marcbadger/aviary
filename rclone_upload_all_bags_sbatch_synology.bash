...
COMMAND="rclone -vv copy --config ${AGENT} --exclude /tmp/ --include ${BAGNAME} --include ${BAGNAME}.md5sum ${DATA_DIR} aviary:BACKUP_BAGS"

echo ${COMMAND}

srun --container-mount-home \
	 --container-image="marcbadger/frame_exporting:rclone" \
	 --container-mounts="/scratch/bird_packages:/bird_packages,/mnt/birds/aviary/data:/mnt/birds/aviary/data,/archive/birds/aviary:/archive/birds/aviary,/archive/$USER:/archive/$USER,/scratch/$USER:/scratch/$USER" \
