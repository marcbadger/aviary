...
BIG_BAG=$2
DEST_DIR=$3 # /archive/birds/aviary/data2019/long_videos/female_annotations_dataset
...
COMMAND="/bin/bash /home/marc/aviary/bag_handling/slice_bags_for_tgia_cluster.bash $BAG_DIR $BIG_BAG $DEST_DIR"
